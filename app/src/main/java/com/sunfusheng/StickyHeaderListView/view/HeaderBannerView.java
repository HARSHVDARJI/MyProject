...
public class HeaderBannerView extends HeaderViewInterface<List<Integer>> {
    ...
    @Override
    protected void getView(List<Integer> list, ListView listView) {
    ...
    private void dealWithTheView(List<Integer> list) {
//        ivList.clear();
    ...
    // 创建要显示的ImageView
    private ImageView createImageView(Integer ivList) {
        ImageView imageView = new ImageView(mActivity);
        AbsListView.LayoutParams params = new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        imageView.setLayoutParams(params);
        imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
        mImageManager.loadResImage(ivList, imageView);
        return imageView;
    }
